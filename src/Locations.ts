 ...
 * <!-- BEGIN WEBSITE DOCUMENTATION (https://github.com/ably/docs/blob/5f9e999399ebf284c0eeecff52a9d1e4d36ce8a8/content/spaces/locations.textile?plain=1#L9-L11) -->
 ...
 * >
 * > The following documentation is copied from the [Spaces documentation website](https://ably.com/docs/spaces).
 * <!-- BEGIN WEBSITE DOCUMENTATION (https://github.com/ably/docs/blob/5f9e999399ebf284c0eeecff52a9d1e4d36ce8a8/content/spaces/locations.textile?plain=1#L211-L215) -->
...
export default class Locations extends EventEmitter<LocationsEventMap> {
   ...
   * >
   * > The following documentation is copied from the [Spaces documentation website](https://ably.com/docs/spaces).
   * <!-- BEGIN WEBSITE DOCUMENTATION (https://github.com/ably/docs/blob/5f9e999399ebf284c0eeecff52a9d1e4d36ce8a8/content/spaces/locations.textile?plain=1#L15-L25) -->
   ...
   * > The following documentation is copied from `docs/class-definitions.md`.
   * <!-- BEGIN CLASS-DEFINITIONS DOCUMENTATION -->
   * <!-- TODO what is locationUpdate event, what to link to? -->
   ...
   * | member.lastEvent.name      | The most recent [event](/spaces/avatar) emitted by the member. Will be one of {@link MembersEventMap.enter | `enter`}, {@link MembersEventMap.update | `update`}, {@link MembersEventMap.leave | `leave`} or {@link MembersEventMap.remove | `remove`}. | String  |
   ...
   * >
   * > The following documentation is copied from the [Spaces documentation website](https://ably.com/docs/spaces).
   * <!-- BEGIN WEBSITE DOCUMENTATION (https://github.com/ably/docs/blob/5f9e999399ebf284c0eeecff52a9d1e4d36ce8a8/content/spaces/locations.textile?plain=1#L95-L107) -->
   ...
   * >
   * > The following documentation is copied from the [Spaces documentation website](https://ably.com/docs/spaces).
   * <!-- BEGIN WEBSITE DOCUMENTATION (https://github.com/ably/docs/blob/5f9e999399ebf284c0eeecff52a9d1e4d36ce8a8/content/spaces/locations.textile?plain=1#L111-L172) -->
