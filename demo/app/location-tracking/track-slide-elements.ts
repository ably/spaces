...
const slideSelectedClasses = ['mb-[200px]'];
...
const selectSlideElement =
  ...
  (htmlElement: HTMLElement, userName: string, newClientId: string, selfId: string, memberIndex: number) => {
...
const deselectSlideElement =
  (space: Space, slideId: string) =>
  (htmlElement: HTMLElement, userName: string, oldClientId: string, selfId: string, memberIndex: number) => {
